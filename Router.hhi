...
namespace Triangle\Router {
    ...
    function simpleRouteDispatcher(
...
namespace Triangle\Router\DataGenerator {
    abstract class RegexBasedAbstract implements \Triangle\Router\DataGenerator {
...
namespace Triangle\Router\Dispatcher {
    abstract class RegexBasedAbstract implements \Triangle\Router\Dispatcher {
...
namespace Triangle\Router\RouteParser {
    class Std implements \Triangle\Router\RouteParser {
